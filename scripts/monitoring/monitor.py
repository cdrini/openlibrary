...
async def monitor_partner_useragents():
    ...
    120 goodreads_scraping/1.0 (Open Library API; contact: you@example.com)
    108 MistralBooks/2.0 (books-legal; ***@mistral.ai)
    102 AwarioSmartBot/1.0 (+https://awario.com/bots.html; ***@awario.com)
     90 HootWise/1.0 (Children's Book Reading Level App; contact: ***@hootwise.app)
     85 Bookhives/1.0 (***@gmail.com)
     85 AliyunSecBot/Aliyun (***@service.alibaba.com)
     80 MyBookApp/1.0 (contact@yourdomain.com)
     76 Bookscovery/1.0 (https://bookscovery.com; ***@bookscovery.com)
     63 knihobot.cz (***@knihobot.cz)
     63 OrelhaDoLivro/1.0 (***@orelhadelivro.com.br; openlibrary-summary)
     ...
     28 Lovelorn/1.0 (***@stalefishlabs.com)
